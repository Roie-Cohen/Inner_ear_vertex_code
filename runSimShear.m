...
savefold = 'stage1_shear';

ps = [0 0.1 0.2 0.4 0.6 0.8 1]; % parameters
for pind = 4:4%1:length(ps)
...
for lat_i=1:20 
    ...
    g = gs{lat_i};
    save([savefold, '/lat(', num2str(lat_i),')_p-shear=',num2str(ps(pind)),'_final.mat'],'g');
end
% fclose(fileID);
